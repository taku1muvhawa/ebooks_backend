...
const booksDbOperations = require('../cruds/books');
...
booksRouter.post('/', async (req, res) => {
    try {
        ...
        const { title, author, cover_url, pdf_url, description, preview_content, price, category } = req.body;
        const result = await booksDbOperations.createBook(title, author, cover_url, pdf_url, description, preview_content, price, category);
...
booksRouter.get('/recommended/bk', async (req, res) => {
...
booksRouter.get('/top-selling', async (req, res) => {
    try {
...
booksRouter.get('/recent', async (req, res) => {
    try {
...
booksRouter.post('/library/:bookId', async (req, res) => {
    try {
...
booksRouter.post('/wishlist/:bookId', async (req, res) => {
    try {
...
booksRouter.get('/wishlist', async (req, res) => {
    try {
...
booksRouter.post('/reading-list/:bookId', async (req, res) => {
    try {
...
booksRouter.get('/reading-list', async (req, res) => {
    try {
...
booksRouter.get('/library/enhanced', async (req, res) => {
    try {
...
// Update user rating
booksRouter.put('/rate/:bookId', async (req, res) => {
    try {
...
booksRouter.get('/:id/pdf', async (req, res) => {
    try {
        const book = await booksDbOperations.getBookById(req.params.id);
...
booksRouter.get('/reading-list/get/all/bks', async (req, res) => {
...
booksRouter.put('/reading-list/:bookId', async (req, res) => {
    try {
...
booksRouter.delete('/reading-list/:bookId', async (req, res) => {
    try {
