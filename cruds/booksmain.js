...
// Create a new book
booksMainObj.createBook = (title, author, cover_url, description, preview_content, price, category) => {
    return new Promise((resolve, reject) => {
        pool.query(
            'INSERT INTO books(title, author, cover_url, description, preview_content, price, category) VALUES (?, ?, ?, ?, ?, ?, ?)',
...
// Get book by ID
booksMainObj.getBookById = (bookId) => {
    return new Promise((resolve, reject) => {
        pool.query('SELECT * FROM books WHERE book_id = ?', [bookId], (err, results) => {
            if (err) return reject(err);
...
// Update book
booksMainObj.updateBook = (bookId, title, author, cover_url, description, preview_content, price, category) => {
    return new Promise((resolve, reject) => {
        pool.query(
...
// Delete book
booksMainObj.deleteBook = (bookId) => {
    return new Promise((resolve, reject) => {
...
booksMainObj.getRecommendedBooks = (userId) => {
    return new Promise((resolve, reject) => {
...
booksMainObj.getTopSellingBooks = () => {
    return new Promise((resolve, reject) => {
        pool.query(`
...
booksMainObj.getRecentlyAddedBooks = () => {
    return new Promise((resolve, reject) => {
...
booksMainObj.addToLibrary = (userId, bookId) => {
    return new Promise((resolve, reject) => {
        pool.query(
...
// Get user library
booksMainObj.getUserLibrary = (userId) => {
    return new Promise((resolve, reject) => {
        pool.query(`
            SELECT b.* 
            FROM books b
...
// Add to wishlist
booksMainObj.addToWishlist = (userId, bookId) => {
    return new Promise((resolve, reject) => {
        pool.query(
...
// Get user wishlist
booksMainObj.getUserWishlist = (userId) => {
    return new Promise((resolve, reject) => {
        pool.query(`
            SELECT b.* 
            FROM books b
...
// Add to reading list
booksMainObj.addToReadingList = (userId, bookId) => {
    return new Promise((resolve, reject) => {
        pool.query(
...
booksMainObj.getUserReadingList = (userId) => {
    return new Promise((resolve, reject) => {
        pool.query(`
            SELECT b.* 
            FROM books b
...
// Get user stats
booksMainObj.getUserStats = (userId) => {
    return new Promise((resolve, reject) => {
        pool.query(`
            SELECT 
...
booksMainObj.getUserBookRatings = (userId) => {
    return new Promise((resolve, reject) => {
        pool.query(`
...
// Update user rating
booksMainObj.updateUserRating = (userId, bookId, rating) => {
    return new Promise((resolve, reject) => {
        pool.query(`
...
booksMainObj.getEnhancedUserLibrary = (userId) => {
    return new Promise((resolve, reject) => {
        pool.query(`
            SELECT 
                b.*,
...
booksMainObj.getUserReadingList2 = (userId) => {
    return new Promise((resolve, reject) => {
        pool.query(`
...
// Add to reading list
booksMainObj.addToReadingList = (userId, bookId, status) => {
    return new Promise((resolve, reject) => {
        pool.query(`
...
booksMainObj.updateReadingListItem = (userId, bookId, status, progress) => {
    return new Promise((resolve, reject) => {
        pool.query(`
...
booksMainObj.removeFromReadingList = (userId, bookId) => {
    return new Promise((resolve, reject) => {
        pool.query(`
